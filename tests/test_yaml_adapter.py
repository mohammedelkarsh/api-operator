...
from workspace_agent.adapters.openapi_generator import generate_adapter_from_openapi
from workspace_agent.adapters.yaml_adapter import YamlAdapter, _token_from_env
...
from workspace_agent.rag.indexer import DocsIndex
...
async def test_yaml_tenant_host_url(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("workspace_agent.adapters.yaml_adapter.httpx.AsyncClient", lambda **k: FakeClient())
